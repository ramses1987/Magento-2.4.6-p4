 ...
 * File:          app/code/Xtento/PdfCustomizer/Controller/Adminhtml/Order/Massaction/PrintpdfInvoice.php
...
class PrintpdfInvoice extends AbstractMassAction
{
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        if (!$invoices->getSize()) {
            $this->messageManager->addErrorMessage(__('There are no invoices related to selected orders.'));
