 ...
 * Last Modified: 2022-11-15T21:53:00+00:00
...
class MassActionPlugin
{
    ...
    public function afterPrepare(MassAction $subject, $interceptedOutput)
    {
        ...
        $enabledActions = explode(',', (string)$this->scopeConfig->getValue('gridactions/general/actions'));
            ...
            if ($this->_isAllowed($actionCode)) {
                ...
                if ($actionCode == '_delete') {
                    $action['confirm'] = [
                        ...
                        'message' => __('Are you sure? You will need a database backup if you want to restore orders to their previous state.')
                    ];
                }
                if ($this->scopeConfig->isSetFlag('gridactions/general/confirm_actions')) {
                    $action['confirm'] = [
