...
{
     /**
     * XML config path search
     */
    const XML_PATH_SEARCH_ENABLE = 'sm_autocompletesearch/autocompletesearch_main/search_enable';
    /**
     * XML config path search delay
     */
    const XML_PATH_SEARCH_DELAY = 'sm_autocompletesearch/autocompletesearch_main/search_delay';

    /**
     * XML config path autocomplete fields
     */
    const XML_PATH_AUTOCOMPLETE_FIELDS = 'sm_autocompletesearch/autocompletesearch_main/autocomplete_fields';

    /**
     * XML config path suggest results number
     */
    const XML_PATH_SUGGESTED_RESULT_NUMBER = 'sm_autocompletesearch/autocompletesearch_main/suggested_result_number';

    /**
     * XML config path product results number
     */
    const XML_PATH_PRODUCT_RESULT_NUMBER = 'sm_autocompletesearch/autocompletesearch_main/product_result_number';

    /**
     * XML config path product result fields
     */
    const XML_PATH_PRODUCT_RESULT_FIELDS = 'sm_autocompletesearch/autocompletesearch_main/product_result_fields';
