...
namespace Sm\AutoCompleteSearch\Block\Autocomplete;

use \Sm\AutoCompleteSearch\Block\Product as ProductBlock;
...
{
    /**
     * @var \Sm\AutoCompleteSearch\Block\Product
     */
    ...
    protected function cropDescription($html)
    {
        ...
        $string = (strlen($string) > 50) ? $this->string->substr($string, 0, 100) . '...' : $string;
