...
use \Sm\AutoCompleteSearch\Model\Source\ProductFields;
 ...
 */
class Product implements \Sm\AutoCompleteSearch\Model\SearchInterface
{
    /**
    ...
    {
        /** @var \Sm\AutoCompleteSearch\Block\Autocomplete\ProductAgregator $productAgregator */
        $productAgregator = $this->objectManager->create(
            'Sm\AutoCompleteSearch\Block\Autocomplete\ProductAgregator'
        )
                                                ->setProduct($product);
